...
// TestInitialElection3 tests the initial election process in an Omni-Paxos cluster with 3 servers.
...
func TestInitialElection3(t *testing.T) {
	...
	cfg.begin("Test (3): [TestInitialElection3] initial election")
...
// TestReElection3 tests the re-election process in an Omni-Paxos cluster with 3 servers.
// The test ensures that:
...
func TestReElection3(t *testing.T) {
	...
	cfg.begin("Test (3): [TestReElection3] election after network failure")
...
func TestManyElections3(t *testing.T) {
	servers := 7
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (3): [TestManyElections3] multiple elections")
...
func TestFigure5aQuorumLoss3(t *testing.T) {
	servers := 5
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (3): [TestFigure5aQuorumLoss3] Partial Connectivity - Quorum-Loss Scenario (Fig 5a)")
	// Get an initial leader
	leader1 := cfg.checkOneLeader()
	log.Warn().Msgf("Initial leader is %v", leader1)

	// Now, we will mimic the scenario presented in Fig 5b
...
func TestFigure5bConstrainedElection3(t *testing.T) {
	servers := 5
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (3): [TestFigure5bConstrainedElection3] Partial Connectivity - Constrained Election Scenario (Fig 5b)")
	// Get an initial leader
	leader1 := cfg.checkOneLeader()
	log.Warn().Msgf("Initial leader is %v", leader1)
...
func TestFigure5cChained3(t *testing.T) {
	servers := 3
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (3): [TestFigure5cChained3] Partial Connectivity - Chained Scenario (Fig 5c)")
	// Get an initial leader
	leader1 := cfg.checkOneLeader()
	log.Warn().Msgf("Initial leader is %v", leader1)
...
func TestBasicAgree4(t *testing.T) {
	servers := 3
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestBasicAgree4] basic agreement")
...
func TestTooManyCommandsAgree4(t *testing.T) {
	servers := 3
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestTooManyCommandsAgree4] high traffic agreement (too many commands submitted fast)")
...
func TestRPCBytes4(t *testing.T) {
	servers := 3
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestRPCBytes4] RPC byte count")
...
// fin.
func TestFailAgree4(t *testing.T) {
	servers := 3
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestFailAgree4] agreement despite follower disconnection")
...
func TestFailNoAgree4(t *testing.T) {
	servers := 5
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestFailNoAgree4] no agreement if too many followers disconnect")
...
func TestConcurrentProposals4(t *testing.T) {
	servers := 3
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestConcurrentStarts4] concurrent Proposal()s")
...
func TestBackup4(t *testing.T) {
	servers := 5
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestBackup4] leader backs up quickly over incorrect follower logs")
...
func TestCount4(t *testing.T) {
	...
	cfg.begin("Test (4): [TestCount4] RPC counts aren't too high")
...
func TestRejoin4(t *testing.T) {
	servers := 3
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestRejoin4] rejoin of partitioned leader")
...
func TestFig5aLogReplication4(t *testing.T) {
	servers := 5
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestFig5aLogReplication4] Partial Connectivity - Quorum-Loss Scenario (Fig 5a)")
	// Get an initial leader
	leader1 := cfg.checkOneLeader()
	log.Warn().Msgf("Initial leader is %v", leader1)
...
func TestFig5bLogReplication4(t *testing.T) {
	servers := 5
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestFig5bLogReplication4] Partial Connectivity - Constrained Election Scenario (Fig 5b)")
	// Get an initial leader
...
func TestFig5cLogReplication4(t *testing.T) {
	servers := 3
	cfg := makeConfig(t, servers, false, false)
	defer cfg.cleanup()

	cfg.begin("Test (4): [TestFig5cLogReplication4] Partial Connectivity - Chained Scenario (Fig 5c)")
	// Get an initial leader
	leader1 := cfg.checkOneLeader()
	log.Warn().Msgf("Initial leader is %v", leader1)
	cfg.one(101, servers, false)
